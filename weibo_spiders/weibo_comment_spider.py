...
# file_name:        weibo_comment_spider.py
...
class WeiboCommentScrapy():
    ...
    def start(self):
        ...
        pageNum = min(pageNum, 50)
        print(f'总评论数：{commentNum}, 总页数{pageNum}, 共能爬取50页')
        for page in tqdm.tqdm(range(pageNum), desc='Page'):
